...
def main():
    ...
    trace_api_call('main', {'csv_path': args.csv_path, 'hypothesis_path': args.hypothesis_path}, 'Execution Started')
    ...
    trace_api_call('main', {'status': 'Execution Completed'}, 'Execution Completed')
